...
import { GripVertical, ChevronRight, ChevronDown, FolderTree, MessageSquare, PackageSearch, Headphones } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <button type="button" onClick={onSelect} className="flex items-center gap-2 flex-1 min-w-0 text-left">
        <span className="w-6 h-6 rounded-lg flex items-center justify-center shrink-0" style={{ background: 'var(--green-light)' }}>
